        ...
        if check_straddle_sl:
            if datetime.datetime.now() > check_time:
                ...
                if sell_new_straddle:
                    ...
                    if 'Expiry' in Parameter.Get_trading_day() and re_no == 0 and index == 'BANKNIFTY':
                        print(f'\nSL Change from {sl} to {re_sl}\n')
                        sl = re_sl
